...
## Завдання 1.6 - Перетворення секунд у години, хвилини та секунди

### Умова завдання

Необхідно написати програму мовою **ANSI C**, яка приймає ціле число (кількість секунд) та виводить еквівалентний час у годинах, хвилинах і секундах.

Рекомендований формат виводу:
7322 секунд еквівалентно 2 годинам 2 хвилинам 2 секундам.

Також необхідно реалізувати підтримку **відʼємних значень**, які інтерпретуються як час у минулому.

### Опис роботи програми

Програма зчитує з клавіатури ціле число секунд та виконує перетворення цього значення у формат: години, хвилини, секунди

У разі введення **відʼємного числа** програма обробляє його як значення часу у минулому та відповідно відображає це у результаті.

Для обчислень використовується наступна логіка: 1 година = 3600 секунд, 1 хвилина = 60 секунд, кількість годин визначається діленням на 3600, кількість хвилин - з остачі після визначення годин, секунди - залишок після визначення хвилин
