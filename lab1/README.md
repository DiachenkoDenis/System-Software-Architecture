...
Програма зчитує з клавіатури ціле число секунд та виконує перетворення цього значення у формат:
- години
- хвилини
- секунди
...
Для обчислень використовується наступна логіка:
- 1 година = 3600 секунд
- 1 хвилина = 60 секунд
- кількість годин визначається діленням на 3600
