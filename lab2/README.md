...
![g_arr](screenshots/pr2(2,2(3)).png)
На скріншоті відображено результат виконання команди.
...
![data](screenshots/pr2(2,2(4)).png)
На скріншоті відображено результат виконання команди.
...
![siz](screenshots/pr2(2,2(5)).png)
![si](screenshots/pr2(2,2(6)).png)
На скріншоті відображено результат виконання команди.
